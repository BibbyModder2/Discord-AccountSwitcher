...
* @source https://github.com/BibbyModder2/Discord-AccountSwitcher
* @authorId 827325534681825321
* @invite https://discord.gg/QU7Q2Qy6
*/
/**
@if (@_jscript)
	...
	const config = {
		info: {
			...
			authors: [
				{
					name: "Gamer_boy_102",
					discord_id: "827325534681825321",
					github_username: "Gamer_boy_102",
					twitter_username: "Gamer_boy_102"
				}
			],
			version: "1.3.5",
